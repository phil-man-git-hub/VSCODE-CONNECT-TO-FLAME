#!/usr/bin/env python3
# -------------------------------------------------------------------------- #
# Filename:     logik_projekt_openclip_precomp.py
# Purpose:      Create OpenClip for LOGIK-PROJEKT precomp clips.
...
# Get the config directory relative to this script
cfg_dir = lp_bootstrap.paths["cfg"] / 'logik_projekt_openclip_precomp'
cfg_file = 'config.xml'
...
def projekt_precomp_media_panel_clips(selection):
    script = LogikProjektOpenClipPrecomp(selection)
    script.media_panel_projekt_clips()

# -------------------------------------------------------------------------- #

def projekt_precomp_batch_clips(selection):
    script = LogikProjektOpenClipPrecomp(selection)
