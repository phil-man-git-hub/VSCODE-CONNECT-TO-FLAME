...
# Purpose:      Create OpenClip for LOGIK-PROJEKT neat video clips.
...
# Get the config directory relative to this script
cfg_dir = lp_bootstrap.paths["cfg"] / 'logik_projekt_openclip_neat_video'
cfg_file = 'config.xml'
...
#     '../cfg/logik_projekt_openclip_neat_video/config.xml'
# )
