...
def create_after_effects_shot_script(shot_name,
    ...
    template_path = os.path.abspath(os.path.join(
        ...
        '..', '..', '..', '..', 'cfg', 'templates', 'adobe', 'after-effects', 'after_effects_shot_script.jsx.template'
    ))

    # Define context for template replacement
    context = {
        'SHOT_SCRIPTS_APP_TASK_SCRIPT': shot_scripts_app_task_script,
        ...
        'SHOT_SCRIPTS_APP_TASK_FILE_PATH': shot_scripts_app_task_file_path
    }
    ...
    with open(shot_scripts_app_task_script_path, 'w') as f:
        f.write(content)
