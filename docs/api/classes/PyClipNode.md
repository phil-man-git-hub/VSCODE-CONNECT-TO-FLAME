...
| `clip` | The associated PyClip or PySequence of the clip node. |
...
| `version_uid` | The clip node's list of available version unique IDs. |
| `version_uids` | The clip node's list of available version unique IDs. |
